class Chip8 {
    constructor(gamepad, display, audio) {
    ...
    start() {
        this.gamepad.start((hexKey, isPressed) => {
            this.keys[hexKey] = isPressed | 0;
        });
        ...
        for (let yline = 0; yline < n; yline++) {
            ...
            for (let xline = 0; xline < 8; xline++) {
                ...
                if((pixel & (0x80 >> xline)) != 0) {
                    let yLocation = ((this.V[y] + yline) * this.display.width);
